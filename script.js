  ...
  fetch(queryURL)
    ...
    .then(function (data) {
      ...
      document.getElementById('nameDate').innerHTML =
        data.name + ' ' + dateConverter + ' ' + '<img src = ' + url + ' >';
      ...
      fetch(uvLink)
        ...
        .then(function (data) {
          ...
          // Five Day Forecast DOM Manipulation Starts Here
          // Day One
